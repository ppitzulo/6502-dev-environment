...
void CPU::execute(uint32_t numCycles)
{
    // while (cycles < numCycles && registers.PC != 0x0088)
...
void CPU::dissassemble(uint8_t opcode, uint8_t operand)
{
    cout << hex << setfill('0');

    cout << setw(4) << registers.PC << " " << setw(2) << static_cast<int>(bus.readMemory(registers.PC)) << " " << setw(2) << static_cast<int>(bus.readMemory(registers.PC + 1)) << " " << setw(2) << static_cast<int>(bus.readMemory(registers.PC + 2));

    if (opcodes[opcode].addressing == &CPU::immediate)
    {
        cout << " " << this->opcodes[opcode].name;
        cout << " #$" << setw(2) << static_cast<int>(bus.readMemory(registers.PC + 1)) << "   ";
    }
    ...
    {
        cout << " " << this->opcodes[opcode].name << " " << setw(2);
        cout << " $" << setw(2) << static_cast<int>(bus.readMemory(registers.PC + 2)) << setw(2) << static_cast<int>(bus.readMemory(registers.PC + 1));
    }
    ...
    {
        std::cout << " " << this->opcodes[opcode].name << " " << std::setw(2);
        cout << " $" << setw(2) << static_cast<int>(bus.readMemory(registers.PC + 2)) << setw(2) << static_cast<int>(bus.readMemory(registers.PC + 1));
    }
    ...
    cout << "\t\tA:" << setw(2) << static_cast<int>(registers.A) << " X:" << setw(2) << static_cast<int>(registers.X) << " Y:" << setw(2) << static_cast<int>(registers.Y) << " P:" << setw(2) << static_cast<int>(flags) << " SP:" << setw(2) << static_cast<int>(registers.SP) << " CYC:" << setw(2) << cycles << endl;
}
